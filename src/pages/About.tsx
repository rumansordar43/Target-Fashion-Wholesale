    ...
    <div className="py-24 px-4 max-w-7xl mx-auto">
      <div className="text-center mb-24">
        ...
        <p className="text-xl text-off-white/60 bangla max-w-3xl mx-auto leading-relaxed">
          "আমরা বাংলাদেশের ফ্যাশন সচেতন তরুণদের জন্য সেরা কোয়ালিটির প্রিমিয়াম টি-শার্ট দিতে প্রতিশ্রুতিবদ্ধ"
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
        ...
        >
          ...
          <div className="space-y-6 text-off-white/70 bangla leading-relaxed">
            <p>প্রিজম কিকস শুধুমাত্র একটি টি-শার্ট ব্র্যান্ড নয়, এটি একটি আস্থার নাম। আমরা জানি আপনার জন্য কোয়ালিটি এবং স্টাইল কতটা গুরুত্বপূর্ণ।</p>
            ...
            <p>আমাদের লক্ষ্য হলো বাংলাদেশের টি-শার্ট মার্কেটকে আরও আধুনিক এবং কোয়ালিটি-ফোকাসড করা, যাতে আপনি গর্বের সাথে আমাদের প্রিমিয়াম টি-শার্টগুলো পরতে পারেন এবং আপনার স্টাইলকে আরও আকর্ষণীয় করতে পারেন।</p>
          </div>
        </motion.div>
